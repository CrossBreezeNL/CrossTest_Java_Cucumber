...
#docker exec -i xtestsqlserver ls -la /scripts/TestCrossTest
#Create database TestDB
docker exec xtestsqlserver /opt/mssql-tools/bin/sqlcmd -S localhost -U SA -P Test1234! -i /scripts/TestCrossTest/testdb.sql
