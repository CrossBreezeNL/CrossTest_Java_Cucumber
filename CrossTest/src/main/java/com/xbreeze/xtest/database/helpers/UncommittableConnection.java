...
public final class UncommittableConnection implements Connection {
	/**
	 ...
	 * @param connection
	 */
	private UncommittableConnection(Connection connection) {
	 ...
	 */
	public static UncommittableConnection fromConnection(Connection connection) {
		return new UncommittableConnection(connection);
	}

	@Override
	/***
	 * We keep the commit method empty, so no commit is performed.
	 */
